...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
    header("location:http://192.168.43.227/mmt/login.php");
    exit;
}
...
<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="index.html" class="nav-item nav-link ">Home</a>
                ...
                <a href="orderonline.php" class="nav-item nav-link active">Order online</a>
	...
	<div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown"><font color="#ff1234">Order online</font></h1>
...
<div id="product-grid">
	...
	?>
		<div class="product-item">
			...
			<div class="cart-action"><input type="text" class="product-quantity" name="quantity" value="2" size="10" /><input type="submit" value="Add to Cart" class="btnAddAction" /></div>
			<div> id=<?php echo  $product_array[$key]["id"]; ?></div> 
		   <div> <a href="http://192.168.43.227/"
           target="popup"
           onclick="window.open('get-product-info.php?id=<?php echo $product_array[$key]["id"] ; ?>','popup','width=600,height=600');return false;">
